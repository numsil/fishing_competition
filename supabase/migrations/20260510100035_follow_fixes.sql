-- 이슈1: get_user_profile_summary의 follower/following COUNT가 soft-deleted 유저까지 세서
-- 리스트(get_followers/get_following은 is_deleted 필터)와 카운트가 불일치.
-- 양쪽 모두 active 유저만 카운트하도록 users JOIN 추가.
