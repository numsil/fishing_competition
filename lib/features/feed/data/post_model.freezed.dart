...
as int,reviewStatus: null == reviewStatus ? _self.reviewStatus : reviewStatus // ignore: cast_nullable_to_non_nullable
...
class _Post implements Post {
  const _Post({required this.id, @JsonKey(name: 'user_id') required this.userId, @JsonKey(name: 'league_id') this.leagueId, @JsonKey(name: 'image_url') required this.imageUrl, @JsonKey(name: 'image_urls') final  List<String>? imageUrls, @JsonKey(name: 'aspect_ratio') this.aspectRatio, @JsonKey(name: 'video_url') this.videoUrl, this.caption, @JsonKey(name: 'fish_type') this.fishType = '배스', this.length, @JsonKey(name: 'lure_type') this.lureType, this.depth, this.temperature, this.location, this.lat, this.lng, this.weight, @JsonKey(name: 'catch_count') this.catchCount = 1, @JsonKey(name: 'is_lunker') this.isLunker = false, @JsonKey(name: 'is_personal_record') this.isPersonalRecord = false, this.score = 0, @JsonKey(name: 'review_status') this.reviewStatus = 'approved', @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(includeFromJson: false, includeToJson: false) this.username = 'Unknown', @JsonKey(includeFromJson: false, includeToJson: false) this.commentsCount = 0, @JsonKey(includeFromJson: false, includeToJson: false) this.avatarUrl = ''}): _imageUrls = imageUrls;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,leagueId,imageUrl,const DeepCollectionEquality().hash(_imageUrls),aspectRatio,videoUrl,caption,fishType,length,lureType,depth,temperature,location,lat,lng,weight,catchCount,isLunker,isPersonalRecord,score,reviewStatus,createdAt,username,commentsCount,avatarUrl]);
