...
@JsonKey(includeFromJson: false, includeToJson: false) int get participantsCount;@JsonKey(includeFromJson: false, includeToJson: false) String get hostUsername;@JsonKey(includeFromJson: false, includeToJson: false) String? get hostAvatarUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,hostId,title,description,shortDescription,location,lat,lng,startTime,endTime,entryFee,maxParticipants,status,fishTypes,rule,catchLimit,prizeInfo,isPublic,allowGallery,const DeepCollectionEquality().hash(introImageUrls),createdAt,participantsCount,hostUsername,hostAvatarUrl]);

@override
String toString() {
  return 'League(id: $id, hostId: $hostId, title: $title, description: $description, shortDescription: $shortDescription, location: $location, lat: $lat, lng: $lng, startTime: $startTime, endTime: $endTime, entryFee: $entryFee, maxParticipants: $maxParticipants, status: $status, fishTypes: $fishTypes, rule: $rule, catchLimit: $catchLimit, prizeInfo: $prizeInfo, isPublic: $isPublic, allowGallery: $allowGallery, introImageUrls: $introImageUrls, createdAt: $createdAt, participantsCount: $participantsCount, hostUsername: $hostUsername, hostAvatarUrl: $hostAvatarUrl)';
}
...
as int,hostUsername: null == hostUsername ? _self.hostUsername : hostUsername // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(includeFromJson: false, includeToJson: false) final  String hostUsername;
@override@JsonKey(includeFromJson: false, includeToJson: false) final  String? hostAvatarUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,hostId,title,description,shortDescription,location,lat,lng,startTime,endTime,entryFee,maxParticipants,status,fishTypes,rule,catchLimit,prizeInfo,isPublic,allowGallery,const DeepCollectionEquality().hash(_introImageUrls),createdAt,participantsCount,hostUsername,hostAvatarUrl]);
