...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,hostId,title,description,location,lat,lng,startTime,endTime,entryFee,maxParticipants,status,fishTypes,rule,catchLimit,prizeInfo,isPublic,createdAt,participantsCount]);

@override
String toString() {
  return 'League(id: $id, hostId: $hostId, title: $title, description: $description, location: $location, lat: $lat, lng: $lng, startTime: $startTime, endTime: $endTime, entryFee: $entryFee, maxParticipants: $maxParticipants, status: $status, fishTypes: $fishTypes, rule: $rule, catchLimit: $catchLimit, prizeInfo: $prizeInfo, isPublic: $isPublic, createdAt: $createdAt, participantsCount: $participantsCount)';
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'host_id')  String hostId,  String title,  String? description,  String location,  double? lat,  double? lng, @JsonKey(name: 'start_time')  DateTime startTime, @JsonKey(name: 'end_time')  DateTime endTime, @JsonKey(name: 'entry_fee')  int entryFee, @JsonKey(name: 'max_participants')  int maxParticipants,  String status, @JsonKey(name: 'fish_types')  String fishTypes,  String rule, @JsonKey(name: 'catch_limit')  int catchLimit, @JsonKey(name: 'prize_info')  String? prizeInfo, @JsonKey(name: 'is_public')  bool isPublic, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(includeFromJson: false, includeToJson: false)  int participantsCount)  $default,) {final _that = this;
switch (_that) {
case _League():
return $default(_that.id,_that.hostId,_that.title,_that.description,_that.location,_that.lat,_that.lng,_that.startTime,_that.endTime,_that.entryFee,_that.maxParticipants,_that.status,_that.fishTypes,_that.rule,_that.catchLimit,_that.prizeInfo,_that.isPublic,_that.createdAt,_that.participantsCount);case _:
  throw StateError('Unexpected subclass');
