...
@JsonKey(name: 'trade_type') String get tradeType;// sell=팝니다, buy=삽니다
 String? get location;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'bumped_at') DateTime? get bumpedAt;// 끌어올리기 정렬 기준(없으면 createdAt)
// joined user data
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,description,price,const DeepCollectionEquality().hash(imageUrls),category,status,tradeType,location,createdAt,bumpedAt,username,userKey,avatarUrl);

@override
String toString() {
  return 'MarketplaceItem(id: $id, userId: $userId, title: $title, description: $description, price: $price, imageUrls: $imageUrls, category: $category, status: $status, tradeType: $tradeType, location: $location, createdAt: $createdAt, bumpedAt: $bumpedAt, username: $username, userKey: $userKey, avatarUrl: $avatarUrl)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'user_id') String userId, String title, String? description, int price,@JsonKey(name: 'image_urls') List<String> imageUrls, String category, String status,@JsonKey(name: 'trade_type') String tradeType, String? location,@JsonKey(name: 'created_at') DateTime createdAt,@JsonKey(name: 'bumped_at') DateTime? bumpedAt,@JsonKey(includeFromJson: false, includeToJson: false) String username,@JsonKey(includeFromJson: false, includeToJson: false) String userKey,@JsonKey(includeFromJson: false, includeToJson: false) String avatarUrl
});
...
/// Create a copy of MarketplaceItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? title = null,Object? description = freezed,Object? price = null,Object? imageUrls = null,Object? category = null,Object? status = null,Object? tradeType = null,Object? location = freezed,Object? createdAt = null,Object? bumpedAt = freezed,Object? username = null,Object? userKey = null,Object? avatarUrl = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  String title,  String? description,  int price, @JsonKey(name: 'image_urls')  List<String> imageUrls,  String category,  String status, @JsonKey(name: 'trade_type')  String tradeType,  String? location, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'bumped_at')  DateTime? bumpedAt, @JsonKey(includeFromJson: false, includeToJson: false)  String username, @JsonKey(includeFromJson: false, includeToJson: false)  String userKey, @JsonKey(includeFromJson: false, includeToJson: false)  String avatarUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MarketplaceItem() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.description,_that.price,_that.imageUrls,_that.category,_that.status,_that.tradeType,_that.location,_that.createdAt,_that.bumpedAt,_that.username,_that.userKey,_that.avatarUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(name: 'user_id')  String userId,  String title,  String? description,  int price, @JsonKey(name: 'image_urls')  List<String> imageUrls,  String category,  String status, @JsonKey(name: 'trade_type')  String tradeType,  String? location, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'bumped_at')  DateTime? bumpedAt, @JsonKey(includeFromJson: false, includeToJson: false)  String username, @JsonKey(includeFromJson: false, includeToJson: false)  String userKey, @JsonKey(includeFromJson: false, includeToJson: false)  String avatarUrl)  $default,) {final _that = this;
switch (_that) {
case _MarketplaceItem():
return $default(_that.id,_that.userId,_that.title,_that.description,_that.price,_that.imageUrls,_that.category,_that.status,_that.tradeType,_that.location,_that.createdAt,_that.bumpedAt,_that.username,_that.userKey,_that.avatarUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(name: 'user_id')  String userId,  String title,  String? description,  int price, @JsonKey(name: 'image_urls')  List<String> imageUrls,  String category,  String status, @JsonKey(name: 'trade_type')  String tradeType,  String? location, @JsonKey(name: 'created_at')  DateTime createdAt, @JsonKey(name: 'bumped_at')  DateTime? bumpedAt, @JsonKey(includeFromJson: false, includeToJson: false)  String username, @JsonKey(includeFromJson: false, includeToJson: false)  String userKey, @JsonKey(includeFromJson: false, includeToJson: false)  String avatarUrl)?  $default,) {final _that = this;
switch (_that) {
case _MarketplaceItem() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.description,_that.price,_that.imageUrls,_that.category,_that.status,_that.tradeType,_that.location,_that.createdAt,_that.bumpedAt,_that.username,_that.userKey,_that.avatarUrl);case _:
  return null;
...
class _MarketplaceItem implements MarketplaceItem {
  const _MarketplaceItem({required this.id, @JsonKey(name: 'user_id') required this.userId, required this.title, this.description, required this.price, @JsonKey(name: 'image_urls') final  List<String> imageUrls = const [], this.category = '기타', this.status = 'selling', @JsonKey(name: 'trade_type') this.tradeType = 'sell', this.location, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'bumped_at') this.bumpedAt, @JsonKey(includeFromJson: false, includeToJson: false) this.username = '', @JsonKey(includeFromJson: false, includeToJson: false) this.userKey = '', @JsonKey(includeFromJson: false, includeToJson: false) this.avatarUrl = ''}): _imageUrls = imageUrls;
...
@override@JsonKey(name: 'trade_type') final  String tradeType;
// sell=팝니다, buy=삽니다
@override final  String? location;
@override@JsonKey(name: 'created_at') final  DateTime createdAt;
@override@JsonKey(name: 'bumped_at') final  DateTime? bumpedAt;
// 끌어올리기 정렬 기준(없으면 createdAt)
// joined user data
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,title,description,price,const DeepCollectionEquality().hash(_imageUrls),category,status,tradeType,location,createdAt,bumpedAt,username,userKey,avatarUrl);
